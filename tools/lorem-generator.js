...
DevForge.registerTool({
  ...
  init() {
    ...
    const LOREM_WORDS = [
      ...
      'mollit','anim','id','est','laborum','praesent','mauris','viverra','lacinia','augue',
      'nibh','cras','pulvinar','mattis','nunc','pellentesque','habitant','morbi','tristique',
      'senectus','netus','malesuada','fames','ac','turpis','egestas','maecenas','pharetra',
      'convallis','posuere','orci','leo','urna','dui','at','semper','risus','venenatis',
      'auctor','purus','ultricies','integer','feugiat','scelerisque','varius','morbi',
      'blandit','cursus','accumsan','dictum','porta','justo','vel','sollicitudin','tempus',
      'facilisis','felis','donec','pretium','vulputate','sapien','nec','sagittis','aliquam',
      'metus','quam','elementum','etiam','proin','libero','faucibus','interdum','massa',
      'tortor','condimentum','lacus','suspendisse','faucibus','velit','dignissim','sodales',
      'neque','ornare','aenean','euismod','lectus','arcu','bibendum','ante','dapibus',
      'placerat','tincidunt','lobortis','natoque','penatibus','magnis','dis','parturient',
      'montes','nascetur','ridiculus','mus','vitae','congue','imperdiet','gravida','luctus',
      'vestibulum','rhoncus','fermentum','iaculis','hac','habitasse','platea','dictumst',
      'quisque','eget','mi','ligula','primis','hendrerit','tellus'
    ];
    ...
    const RANDOM_WORDS = [
      ...
      'give','day','most','us','great','between','need','large','often','around','each','next',
      'under','open','seem','together','keep','still','found','hand','high','place','small',
      'home','never','running','quickly','strong','building','creative','solution','design',
      'modern','system','process','important','develop','software','digital','platform',
      'experience','technology','project','create','build','code','data','network','cloud'
    ];
